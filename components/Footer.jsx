  ...
  return (
    <>
        <div className='flex flex-col bg-yellow-300 text-black text-center py-7  '>
            ...
            <span>        
            <a href='/login'  >
            <button className='bg-black text-white text-3xl p-3 mt-3 hover:text-gray-600 transition' >
                ĐĂNG KÝ NGAY
        ...
        <div className='bg-gray-700 text-white py-5 grid grid-cols-2  lg:grid-cols-5 justify-start px-4  text-sm lg:text-normal  ' >
            
            <div className='mt-2 hover:text-gray-500' >Cài đặt Cookie</div>
            
            <div className='mt-2 hover:text-gray-500' >Chính sách bảo mật</div>
            
            <div className='mt-2 hover:text-gray-500' > Điều khoản và dịch vụ</div>
            
            <div className='mt-2 hover:text-gray-500' >Xuất bản bởi</div>
                
            <div className=' mt-2 hover:text-gray-500 ' >   © 2025 Công Ty TNHH ShoeShop</div>
