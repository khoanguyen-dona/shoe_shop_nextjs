    ...
    <div className='mt-20  flex flex-col ' >
        ...
        <form action="" className='space-y-4 flex flex-col mt-10  ' >
            <div>           
                ...
                <input  className='w-1/3 border-2 p-2 bg-gray-200'  type="text" value={'O-321312'} 
                    disabled  />
            </div>

            <div>
                <p className='text-sm text-gray-500 '>Tên khách hàng </p>
                <input  className='w-1/3 border-2 p-2 '  type="text" value={clientName} 
                    onChange={(e)=>setClientName(e.target.value)}  />
            </div>

            <div>
            <p className='text-sm text-gray-500'>Ngày đặt hàng</p>
                <input  className='w-1/3 border-2 p-2 '  type="text" value={date} 
            ...
            <p className='text-sm text-gray-500'>Tổng cộng(Vnđ) </p>
                <input  className='w-1/3 border-2 p-2 '  type="text" value={total} 
            ...
            <div>
                ...
                <input  className='w-1/3 border-2 p-2 '  type="text" value={paymentMethod} 
                    onChange={(e)=>setPaymentMethod(e.target.value)}  />
            </div>

            <div>
            <p className='text-sm text-gray-500'>Email khách hảng</p>
                <input  className='w-1/3 border-2 p-2 '  type="email" value={email} 
                    onChange={(e)=>setEmail(e.target.value)}  />
            </div>

            <div>
            <p className='text-sm text-gray-500'>Số điện thoại liên hệ</p>
                <input  className='w-1/3 border-2 p-2 '  type="number" value={phoneNumber} 
                    onChange={(e)=>setPhoneNumber(e.target.value)}  />
            </div>
            
            <div>
            <p className='text-sm text-gray-500'>Địa chỉ</p>
                <textarea  className='w-1/3 border-2 p-2 '  type="text" value={address} 
                    onChange={(e)=>setAddress(e.target.value)}  />
            </div>

            <div>
            <p className='text-sm text-gray-500'>Ghi chú</p>
                <textarea  className='w-1/3 border-2 p-2 '  type="text" value={message} 
